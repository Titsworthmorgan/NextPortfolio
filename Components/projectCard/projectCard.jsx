...
export default async function ProjectCard(props) {
  ...
  return (
    <div className=" flex justify-center items-center flex-row w-full flex-wrap mb-5">
      {projects.map((project) => (
        <div
          ...
          key={project._id}
        >
          <div className="flex flex-col items-center justify-center w-full flex-1 px-15 text-center">
          ...
          <div className="flex flex-col items-center self-center justify-center flex-wrap"> 
            <p className="text-gray-300 m-2">{project.content}</p>
            <h2 className="text-white mb-2 text-lg font-bold border-b border-gray-500">Tech stack</h2>
            <div className="flex items-center self-center justify-center flex-wrap mb-7 w-full gap-3">
